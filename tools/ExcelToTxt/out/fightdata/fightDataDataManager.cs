...
using DG.Tweening;
using UnityEngine;
public class fightDataDataManager
{
	...
	public static fightDataDataManager instance = null;
	public static fightDataDataManager getInstance()
	{
    	if (instance == null)
    	{
     	   instance = new fightDataDataManager();
    	}
		return instance;
	}
